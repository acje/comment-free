...
R1 [5]: Existing repository documentation and configuration remain authoritative; accepting this retrospective corpus does not introduce new policy or supersede existing decisions.

## Consequences

Local development and CI can validate and discover a nonempty CF corpus.
This record leaves the single-crate architecture, Rust toolchain and lexer
